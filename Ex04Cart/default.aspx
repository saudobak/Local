<%@ Page Language="C#" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="Order" %>
...
<body>
    ...
    <section>
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString='<%$ ConnectionStrings:ConnectionString %>' SelectCommand="SELECT [ProductID], [Name], [ShortDescription], [LongDescription], [UnitPrice], [ImageFile] FROM [Products]"></asp:SqlDataSource>
    <form id="form1" runat="server">
        ...
        <div id="productData">
            ...
            <asp:Button ID="btnCart" runat="server" Text="Go to Cart" CausesValidation="False" PostBackUrl="~/Cart.aspx" OnClick="btnCart_Click" />
        </div>
